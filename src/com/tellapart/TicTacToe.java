...
class TicTacToe {
	...
	// Player can be a first class object
	class Player {
		private String name;
		private int player_type;
		//Player order never used
	...
	public TicTacToe() {
		...
		// Players are fixed in nature shouldn't be the case. this should have been configuration based
		System.out.println("Enter player name");
		player1 = new Player("", 2, 0, new SimpleMoveStrategy(this));

		player2 = new Player(getUserInput(), 1, 1, new HumanMove(this));
	...
	public static void main(String[] args) {
		...
		// Game can follow builder/factory pattern
		...
		while (game.isWinningConfig() == WinConfig.NONE) {
			...
			//Not checking for invalid move.. setMove() method may be clubbed with getMove method for better collaboration
